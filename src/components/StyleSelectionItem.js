...
const StyleSelectionItem = () => {
    const styles = [
        { value: 'style_1', label: <div><img src={style_1} height="100vh" width="100vh"/></div> },
        { value: 'style_2', label: <div><img src={style_2} height="100vh" width="100vh"/></div> },
        { value: 'style_3', label: <div><img src={style_3} height="100vh" width="100vh"/></div> },
    ];
